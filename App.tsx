...
const recentClaims = [
  { name: "Chloe M.", amount: 500 },
  { name: "Aria J.", amount: 500 },
  { name: "Madison L.", amount: 500 },
  { name: "Riley S.", amount: 500 },
  { name: "Zoey P.", amount: 500 },
  { name: "Lily T.", amount: 500 },
  { name: "Hannah K.", amount: 500 },
  { name: "Layla R.", amount: 500 },
  { name: "Nora B.", amount: 500 },
  { name: "Mila W.", amount: 500 },
  { name: "Aiden N.", amount: 500 },
  { name: "Jackson G.", amount: 500 },
  { name: "Lucas D.", amount: 500 }
];
...
export default function App() {
  ...
  return (
    <div className="min-h-[100dvh] bg-[#f0f5fa] flex flex-col items-center justify-center py-2 sm:py-10 px-4 font-sans selection:bg-[#0055A5]/20 selection:text-[#0055A5] overflow-hidden">
      ...
      <div className="h-[40px] sm:h-[46px] w-[340px] max-w-full flex justify-center relative mb-3 sm:mb-8 shrink-0">
        {showNotification && (
          <div className="absolute top-0 bg-white rounded-full px-4 sm:px-6 py-2 sm:py-2.5 shadow-[0_2px_10px_rgb(0,0,0,0.04)] border border-gray-100 flex items-center gap-1.5 sm:gap-2 animate-in fade-in slide-in-from-top-4 duration-500 transition-all w-full sm:w-auto justify-center">
            <Sparkles className="w-4 h-4 sm:w-5 sm:h-5 text-[#E31837] shrink-0" />
            <span className="text-gray-700 text-[13px] sm:text-[15px] whitespace-nowrap truncate">
              <span className="text-[#0055A5] font-medium">{recentClaims[claimIndex].name}</span> claimed ${recentClaims[claimIndex].amount}!
            </span>
          </div>
        )}
      </div>
      ...
      <div className="bg-white rounded-[24px] sm:rounded-[32px] shadow-[0_8px_30px_rgb(0,0,0,0.08)] w-full max-w-[380px] p-5 sm:p-8 pt-6 sm:pt-10 flex flex-col items-center animate-in fade-in zoom-in-95 duration-700 max-h-[calc(100svh-80px)] overflow-y-auto noscrollbar">
        ...
        <div className="flex items-center justify-center mb-4 sm:mb-8 shrink-0 pt-2 w-full">
          <img 
            ...
            alt="Domino's" 
            className="w-[100px] sm:w-[120px] h-auto object-contain drop-shadow-sm"
            referrerPolicy="no-referrer"
          />
        </div>

        {/* Prize Value */}
        <h1 className="text-[#0055A5] text-[52px] sm:text-[72px] font-bold leading-none mb-1 sm:mb-3 tracking-tight shrink-0">
          $500
        </h1>
        ...
        <div className="bg-[#f2f3f5] rounded-[16px] sm:rounded-[24px] p-4 sm:p-6 w-full space-y-2.5 sm:space-y-4 mb-4 sm:mb-8 shrink-0">
          {[
            ...
            <div key={i} className="flex items-center gap-3 sm:gap-4">
              <div className="w-6 h-6 sm:w-7 sm:h-7 shrink-0 rounded-full bg-[#0055A5] text-white flex items-center justify-center text-[12px] sm:text-[13px] font-bold shadow-sm">
                {i + 1}
              </div>
        ...
        <button 
          onClick={() => window.location.href = 'https://giftclick.org/aff_c?offer_id=679&aff_id=144760'}
          className="w-full bg-[#E31837] hover:bg-[#C8102E] transition-colors active:scale-[0.96] text-white rounded-full py-3 sm:py-4 px-4 text-[15px] sm:text-lg font-bold flex items-center justify-center gap-2 sm:gap-3 shadow-lg shadow-[#E31837]/20 mb-3 sm:mb-6 group shrink-0"
        >
        ...
        <div className="flex flex-col items-center justify-center pt-1 shrink-0 scale-[0.85] sm:scale-100 transform origin-top">
          ...
          <div className="text-[13px] font-bold text-[#031d36] mb-1.5 uppercase tracking-[0.02em] text-center">
            4.9 OUT OF 5 BASED ON 14,821 REVIEWS
          </div>
